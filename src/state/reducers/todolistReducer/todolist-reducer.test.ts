...
beforeEach(() => {
    ...
    startState = [
        {id: todolistId1, title: "What to learn", filter: All,addedDate:getCurrentDate,
        order:1,entityStatus:Idle},
        {id: todolistId2, title: "What to buy", filter: All,addedDate:getCurrentDate,
        order:1,entityStatus:Idle}
    ]
})
...
test('correct todolist should be added', () => {
    const endState = todolistsReducer(startState, addTodolistAC({newTitle:newTodolistTitle}))
